...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "𝗦𝗻 𝙓 🎶 𝗺𝘂𝘀𝗶𝗰")
OWNER_ID = list(map(int, getenv("OWNER_ID", "5915456351").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO"https://github.com/Snoffcial/Snmusicbot")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "bikash")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/snmusic2")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/snmusic1")
...
START_IMG_URL = getenv("START_IMG_URL", "https://photos.app.goo.gl/XbTqSGYVWdvbwz879")
PING_IMG_URL = getenv("PING_IMG_URL", "https://photos.app.goo.gl/egw9ntqWitYBx75g7")
...
if PING_IMG_URL:
    if PING_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://photos.app.goo.gl/egw9ntqWitYBx75g7"

if START_IMG_URL:
    if START_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://photos.app.goo.gl/XbTqSGYVWdvbwz879"
